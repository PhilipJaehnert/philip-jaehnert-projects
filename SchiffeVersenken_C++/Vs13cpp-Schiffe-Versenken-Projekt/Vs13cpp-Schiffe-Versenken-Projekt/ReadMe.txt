========================================================================
    KONSOLENANWENDUNG: Vs13cpp-Schiffe-Versenken-Projekt-Projektübersicht
========================================================================

Diese Vs13cpp-Schiffe-Versenken-Projekt-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Vs13cpp-Schiffe-Versenken-Projekt-Anwendung besteht.


Vs13cpp-Schiffe-Versenken-Projekt.vcxproj
...
Vs13cpp-Schiffe-Versenken-Projekt.vcxproj.filters
...
Vs13cpp-Schiffe-Versenken-Projekt.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Vs13cpp-Schiffe-Versenken-Projekt.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
